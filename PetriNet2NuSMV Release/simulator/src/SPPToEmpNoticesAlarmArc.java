...
public class SPPToEmpNoticesAlarmArc extends Arc implements InArc, OutArc{
    public SPPToEmpNoticesAlarmArc(SPPPlace place, EmpNoticesAlarmTransition transition) {
