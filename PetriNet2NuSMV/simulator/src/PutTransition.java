...
public class PutTransition extends Transition{
    private static List<Binding> _bindings;

    public PutTransition(RtcpNetEventSender eventSender) {
        super(eventSender);
    }
    ...
    private PutBinding _binding;

    @Override
    public PutBinding getBinding() {
        return _binding;
    }

    public void setBinding(PutBinding value) {
        _binding = value;
    }

    @Override
    public void SetBinding(Binding binding) {
        setBinding((PutBinding)binding);
    }
