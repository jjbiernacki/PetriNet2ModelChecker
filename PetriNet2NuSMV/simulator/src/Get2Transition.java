...
public class Get2Transition extends Transition{
    private static List<Binding> _bindings;

    public Get2Transition(RtcpNetEventSender eventSender) {
        super(eventSender);
    }
    ...
    private Get2Binding _binding;

    @Override
    public Get2Binding getBinding() {
        return _binding;
    }

    public void setBinding(Get2Binding value) {
        _binding = value;
    }

    @Override
    public void SetBinding(Binding binding) {
        setBinding((Get2Binding)binding);
    }
    ...
    private static List<Binding> GenerateBindings() {
        ...
        __bindings.add(new Get2Binding());
