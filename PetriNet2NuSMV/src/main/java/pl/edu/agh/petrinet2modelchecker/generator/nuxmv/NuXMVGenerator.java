...
import pl.edu.agh.petrinet2modelchecker.model.pt.PlaceType;
import pl.edu.agh.petrinet2modelchecker.model.pt.PTReachabilityGraph;
import pl.edu.agh.petrinet2modelchecker.model.pt.PTState;
...
public class NuXMVGenerator {
	...
	private void generateNextVarValues() {
		for(PTPlace PTPlace : PTReachabilityGraph.getPTPlaces()) {
			appendLine(PTPlace.getValidNuXMVName() + " := " + StrRes.CASE);
			indent++;
	...
	private void generateVariables() {
		...
		for(PTPlace PTPlace : PTReachabilityGraph.getPTPlaces()) {
			...
			appendLine(PTPlace.getValidNuXMVName() + " : " + typeName + ";");
		}
